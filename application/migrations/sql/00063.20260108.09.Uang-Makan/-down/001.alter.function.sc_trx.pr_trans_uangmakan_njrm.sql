create OR REPLACE function sc_trx.pr_trans_uangmakan_njrm(vr_tglawal character, vr_tglakhir character, vr_kdcabang character, vr_userid character) returns text
    language plpgsql
as
$$
DECLARE
